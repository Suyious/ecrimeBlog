...
function ViewPager() {
    ...
    return (
        <div className="ViewPager">
            <img className="PagerImg" src={backs[background].image} alt="blog"/>
            ...
            <Link to={`/blog/${backs[background].key}`} className="title">
                <h2 className="ViewLink">{backs[background].heading}</h2>
            </Link>
